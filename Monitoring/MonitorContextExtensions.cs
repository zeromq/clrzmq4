namespace ZeroMQ.Monitoring
{
    ...
    {
        /// <summary>
        /// Creates a <see cref="ZmqMonitor"/> (a <see cref="ZmqSocketType.PAIR"/> socket) and connects
        ...
        public static ZmqMonitor CreateMonitorSocket(this ZmqContext zmqContext, string endpoint)
        {
            ...
            return new ZmqMonitor(zmqContext.CreateSocket(ZmqSocketType.PAIR), endpoint);
        }
    }
}
